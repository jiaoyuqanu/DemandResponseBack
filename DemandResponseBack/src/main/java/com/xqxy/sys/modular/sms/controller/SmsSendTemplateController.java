...
public class SmsSendTemplateController {
    ...
    /**
     * @description: 短信模板不分页查询
     * @param:
     * @return:
     * @author: PengChuqing
     * @date: 2021/4/4 21:22
     */
    @ApiOperation(value="短信模板不分页查询", notes="短信模板分页查询", produces="application/json")
    @PostMapping("/list")
    public ResponseData<?> list(@RequestBody SmsSendTemplateParam templateParam) {
        return ResponseData.success(smsSendTemplateService.list(templateParam));
    }
