...
package com.xqxy.core.pojo.page;
...
public class PageResult<T> implements Serializable {
    ...
    public PageResult(List<T> t, List<T> tp, String pageNo, String pageSize) {
        this.setRows(tp);
        this.setTotalRows(Convert.toInt(t.size()));
        this.setPageNo(Convert.toInt(pageNo));
        this.setPageSize(Convert.toInt(pageSize));
//        this.setTotalPage(PageUtil.totalPage(Convert.toInt(page.getTotal()),
//                Convert.toInt(page.getSize())));
//        this.setRainbow(PageUtil.rainbow(Convert.toInt(page.getCurrent()),
//                Convert.toInt(this.getTotalPage()), RAINBOW_NUM));
