...
public interface ProjectService extends IService<Project> {
     ...
     * @return
     */
    ResponseData getBaselineGrievance(EventParam eventParam);

    Page<BaseLineDetail> getBaselineGrievanceData(EventParam eventParam);
     ...
     * @return
     */
    ResponseData getBaselineGrievanceCalculate(ConsBaselineAllParam consBaselineAllParam);
