...
public interface PlanConsMapper extends BaseMapper<PlanCons> {
     ...
     *我的申述
     */
    Page<Event> getMyRepresentationPage(Page<?> page,@Param("consInvitationParam") ConsInvitationParam consInvitationParam);


    //Page<Event> getMyRepresentationPageTwo(Page<?> page,@Param("consInvitationParam") ConsInvitationParam consInvitationParam);
     ...
     * @return Event
     */
    ConsEvaluationAppeal getMyRepresentationById(@Param("consInvitationParam")MyRepresentation consInvitationParam);
     ...
     * @return
     */
    Page<PlanCons> pageConsExecute(Page page, @Param("planConsParam") PlanConsParam planConsParam);


    /**
     * 统计 执行效果统计 事件执行统计
     */
    List<EventStatisticsResult> eventStatistics();
}
