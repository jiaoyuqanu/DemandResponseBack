...
public class WorkController {
     ...
     */
    @ApiOperation(value = "提供给第三方 全省的审核通过的签约用户数和每个项目明细的签约负荷")
    @RequestMapping("/groupContractByTimeType")
    public ResponseData groupContractByTimeType(@RequestBody WorkProjectParam workProjectParam) {
        return ResponseData.success(projectService.groupContractByTimeType(workProjectParam));
    }
}
