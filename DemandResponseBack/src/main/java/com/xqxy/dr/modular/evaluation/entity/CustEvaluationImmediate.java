...
@TableName("dr_cust_evaluation_immediate")
@ApiModel(value="CustEvaluationImmediate对象", description="客户当日执行效果评估")
public class CustEvaluationImmediate implements Serializable {
