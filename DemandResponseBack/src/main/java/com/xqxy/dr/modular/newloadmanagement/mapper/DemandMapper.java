...
public interface DemandMapper {
    ...
    @Select("select * from dr_demand where stregy_id = #{stregyId}")
    List<Drdemand> selectDrdemandByStregyId(@Param("stregyId") String stregyId);

    int updateOrderInfoByStregyId(Drdemand drdemand);


    List<Event> selectEventByRegulateId(@Param("regulateId") String regulateId);
