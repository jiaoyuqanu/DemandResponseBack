...
@Data
@TableName("dr_cons_curve") //表名 用户功率曲线
public class DrConsCurve {
    /**
     * 本实体记录的唯一标识，产生规则为流水号
     */
    private Long dataId;
    ...
    private String dataType;//数据状态，1：正常 ,2:无数据,3:补录的数据, 4:数据为0重新覆盖的数据 (状态为 1,3,4视为正常数据)

//    private String consNo;
    private int sgementId;
