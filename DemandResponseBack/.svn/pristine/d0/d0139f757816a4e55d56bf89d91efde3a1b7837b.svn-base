...
public interface BaselineAndMeasurementMapper {
    ...
    List<Long> getEventId2(@Param(value = "time") LocalDate time);
    ...
    Point96Vo getTimeBaseLine(@Param(value = "event_id") String eventid);

    DrEventTime getEventTime2(@Param(value = "event_id") String eventid);

    String getTime(@Param(value = "event_id") String eventid);
}
