...
@TableName("dr_subsidy_monthly_cust")
@ApiModel(value="SubsidyMonthlyCust对象", description="月补贴")
public class SubsidyMonthlyCust extends BaseEntity implements Serializable {
