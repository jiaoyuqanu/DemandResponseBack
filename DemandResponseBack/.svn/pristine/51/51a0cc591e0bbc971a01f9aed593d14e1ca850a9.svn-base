...
public interface PlanConsService extends IService<PlanCons> {
 ...
 List<PlanCons> list(PlanConsParam planConsParam);
     ...
     */
    Map<String,Object> exportConsMonitor(PlanConsParam planConsParam) throws ExecutionException, InterruptedException;
   ...
   String executePlan(ExecutePlanConsParam planConsParam);
    ...
    List<PlanCons> exportConsExecuteList (DeleteConsParam deleteRuleParam) throws ExecutionException, InterruptedException;

    List<PlanCust> exportCustExecuteList(DeleteCustParam deleteRuleParam);
