...
@Data
public class ConsBaselineAllParam extends BaseParam {

    /**
     * 负荷基线标识
     */
    @TableId(value = "baseline_id", type = IdType.AUTO)
    ...
    @ApiModelProperty(value = "申诉提升负荷(kW)")
    private BigDecimal differ;

    @ApiModelProperty(value = "申诉提升比率(%)")
    private String rate;
