...
public class DictDataParam extends BaseParam {
     ...
     * 主键
     */
    @NotNull(message = "dataId不能为空，请检查dataId参数", groups = {edit.class, delete.class, detail.class, changeStatus.class})
    private Long dataId;
     ...
     * 编码
     */
    @NotBlank(message = "编码不能为空", groups = {dropDown.class, add.class, edit.class})
    private String code;
